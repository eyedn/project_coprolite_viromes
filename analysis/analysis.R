...
vir_ec_counts <- read.csv("~/Documents/Research/data/bacterial_gene_counts.csv",
...
create_heatmap(vir_ec_t_mat, vir_ec_diff_repres, color_range, subset_top,
               heat_vir_ec, heat_dir)

# show ec proportions
vir_ec_median <- get_cat_medians(vir_ec_t_mat[, rownames(vir_ec_diff_repres)[1:100]])
...
####### 3. phage_ec ###########################################################
# read in raw counts data
phage_ec_counts <- read.csv("~/Documents/Research/data/phage_ec_counts.csv",
                          header = TRUE, row.names = 1)
...
# show ec proportions
phage_ec_median <- get_cat_medians(phage_ec_t_mat[, rownames(phage_ec_diff_repres)[1:100]])
