...
#		3a_3_get_counts_viral_lifestyle.sh 
###############################################################################
...
echo "===================================================================================================="
echo "$(timestamp): 3a_3_get_counts_viral_lifestyle: generating lifestyle counts"
echo "===================================================================================================="
# create a list of all files to generate counts from
mkdir -p $data_dir
ls $search_dir/$search_file > $predict_list
echo "$(timestamp): 3a_3_get_counts_viral_lifestyle: generated file of all file paths needed"
echo "$(timestamp): 3a_3_get_counts_viral_lifestyle: using the following files:"
cat $predict_list
...
if ls $csv_path 1> /dev/null 2>&1; then
	echo "$(timestamp): 3a_3_get_counts_viral_lifestyle: lifestyle counts csv created"
else
	echo "$(timestamp): 3a_3_get_counts_viral_lifestyle: ERROR! lifestyle counts csv not found"
	exit 1
fi
