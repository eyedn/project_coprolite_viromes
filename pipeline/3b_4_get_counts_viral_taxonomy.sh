...
#		3a_4_get_counts_viral_taxonomy.sh 
###############################################################################
...
echo "===================================================================================================="
echo "$(timestamp): 3a_4_get_counts_viral_taxonomy: generating families counts"
echo "===================================================================================================="
# create a list of all files to generate counts from
mkdir -p $data_dir
ls $search_dir/$search_file > $predict_list
echo "$(timestamp): 3a_4_get_counts_viral_taxonomy: generated file of all file paths needed"
echo "$(timestamp): 3a_4_get_counts_viral_taxonomy: using the following files:"
cat $predict_list
...
if ls $csv_path 1> /dev/null 2>&1; then
	echo "$(timestamp): 3a_4_get_counts_viral_taxonomy: families counts csv created"
else
	echo "$(timestamp): 3a_4_get_counts_viral_taxonomy: ERROR! families counts csv not found"
	exit 1
fi
