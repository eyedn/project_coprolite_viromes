...
echo "$(timestamp): collect_hosts_counts: generated file of all file paths needed"
echo "$(timestamp): collect_hosts_counts: using the following files:"
cat $predict_list

# generate counts with python script
echo "===================================================================================================="
echo "$(timestamp): collect_hosts_counts: generating host counts"
echo "===================================================================================================="
...
if ls $csv_path 1> /dev/null 2>&1; then
	echo "$(timestamp): collect_hosts_counts: host counts csv created"
else
	echo "$(timestamp): collect_hosts_counts: host counts csv not found"
	exit 1
fi
