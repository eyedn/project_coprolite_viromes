...
if ls ${contigs_file}* 1> /dev/null 2>&1; then
	echo "$(timestamp): viral_annot_phage: contigs file found"
else
	echo "$(timestamp): viral_annot_phage: contigs file not found"
	rmdir $annot_dir
	exit 1
fi
...
if ls $sample_annot_dir 1> /dev/null 2>&1; then
	echo "$(timestamp): viral_annot_phage: annotations already completed"
	return 0
fi

# annotation function uses prokka
echo "===================================================================================================="
echo "$(timestamp): viral_annot_phage: $origin; $sample"
echo "===================================================================================================="
